...
log "- !Note: re-login required to be able to see the gnome extension listed"
...
log "1. Set POS URL:         sudo nano /etc/pos-device/pos-url.conf"
log "2. Re-login to apply autostart and GNOME extension changes. Then:"
log "3. Enable extension:    gnome-extensions enable pdt@kaivanmaurik.com"
log ""
